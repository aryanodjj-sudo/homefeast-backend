...
// originalPrice added so Price.jsx's discount badge (struck-through MRP +
// "X% OFF") has something to compare against - the schema previously had
// no such field, which is why the discount never showed on the live site
// no matter what the frontend code did.
const meals = [
  { name: "Paneer Butter Masala", category: "Indian", price: 250, originalPrice: 349, rating: 4.8, isVeg: true, chefId: 1, image: "https://commons.wikimedia.org/wiki/Special:FilePath/Paneer_Butter_Masala.jpg", description: "Soft paneer cubes simmered in a rich, creamy tomato-butter gravy, finished with a touch of cream and kasuri methi. A North Indian favourite best enjoyed with butter naan or steamed rice." },
